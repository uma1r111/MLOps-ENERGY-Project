...
# ---------------- MODEL PARAMS ----------------
# --- Use this block for Final_LSTM_MultiOutput_Keras ---
run_name = "Final_LSTM_MultiOutput_Keras"
params = {
    "n_units": 128,
    "n_lstm_layers": 1,
    "activation": "tanh",
...
# --- Uncomment this block for Final_LSTM_MultiOutput_Optuna ---
# run_name = "Final_LSTM_MultiOutput_Optuna"
# params = {
#     "n_units": 43,
#     "n_dense_units": 109,
#     "dropout": 0.19145830941678826,
#     "recurrent_dropout": 0.055435392313375666,
#     "learning_rate": 0.0031867088216470944,
#     "activation": "tanh",
#     "n_lstm_layers": 1
# }
...
with mlflow.start_run(run_name=run_name):
    ...
    model = build_lstm_model((LOOKBACK, X.shape[2]), params)
    history = model.fit(
...
print("✅ LSTM model training and MLflow logging completed successfully.")
