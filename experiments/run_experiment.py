...
class ExperimentEvaluator:
    ...
    def run_strategy(self, strategy_name: str, system_prompt: str, eval_data: List[Dict]):
        ...
        for item in tqdm(eval_data, desc=f"Testing {strategy_name}"):
            ...
            try:
                ...
                # 2. Metrics
                cos_sim = self._calculate_cosine_similarity(generated_answer, ground_truth)
...
def main():
    ...
    print(f"🚀 Starting Prompt Engineering Experiment on {len(eval_data)} test cases...")
